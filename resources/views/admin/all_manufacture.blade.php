				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								<td>{{ $v_manufacture->manufacture_id}}l</td>
								...
								<td class="center">
                                    ...
                                    @endif
                                    <a class="btn btn-success" href="{{URL::to('/edit-manufacture/' .$v_manufacture->manufacture_id)}}">
										<i class="halflings-icon white edit"></i>
                                    </a>
                                    <a class="btn btn-success" href="{{URL::to('/delete-manufacture/' .$v_manufacture->manufacture_id)}}" id="delete">
