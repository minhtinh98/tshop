						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
                                    ...
                                    <a class="btn btn-success" href="{{URL::to('/view-order/' .$v_order->order_id)}}">
										<i class="halflings-icon white edit"></i>
                                    </a>
                                    <a class="btn btn-success" href="{{URL::to('/delete/' .$v_order->order_id)}}" id="delete">
