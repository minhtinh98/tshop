						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
                                    ...
                                    @endif
                                    <a class="btn btn-success" href="{{URL::to('/edit-product/' .$v_product->product_id)}}">
										<i class="halflings-icon white edit"></i>
                                    </a>
                                    <a class="btn btn-success" href="{{URL::to('/delete-product/' .$v_product->product_id)}}" id="delete">
